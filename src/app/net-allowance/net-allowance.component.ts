...
@Component({
  selector: 'app-net-allowance',
  templateUrl: './net-allowance.component.html',
  styleUrls: ['./net-allowance.component.css']
})
export class NetAllowanceComponent implements OnInit {
